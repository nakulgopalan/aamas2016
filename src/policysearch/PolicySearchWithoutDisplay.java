...
public class PolicySearchWithoutDisplay extends MDPSolver implements Planner, QProvider, QFunction{
    ...
    public PolicySearchWithoutDisplay(OOSADomain d, FeatureDatabase fd, int trialNum, StateEnumerator se, double ridgeFactor){
    ...
    public PolicySearchWithoutDisplay(OOSADomain d, FeatureDatabase fd, StateEnumerator se, double ridgeFactor){
        this.featureDatabase = fd;
        this.domain = d;
        this.rf = ((FactoredModel)d.getModel()).rewardFunction();
        this.tf = ((FactoredModel)d.getModel()).terminalFunction();
